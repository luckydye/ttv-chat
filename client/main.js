(function() {
    const env = {"__ENV__":"development","__PACKAGE__":{"version":"1.0.0","name":"better-twitch-chat","description":"A lightweight Twitch Chat App with all the Twitch Chat features."}};
    try {
        if (process) {
    ...
    render() {
        return html `
            <div class="titlebar">
                ...
                <div>
                    <div class="titlebar-button" @click="${() => b.minimize()}">
                        <img src="https://api.iconify.design/mdi:window-minimize.svg" alt="minimize" />
                    </div>
                    <div class="titlebar-button" @click="${() => b.toggleMaximize()}">
                        <img src="https://api.iconify.design/mdi:window-maximize.svg" alt="maximize" />
                    </div>
                    <div class="titlebar-button" @click="${() => b.close()}">
